...
const styles = (screenContext, width, height) =>
  StyleSheet.create({
    ...
    OpenPdfButton:{backgroundColor:ColorPalette.green,justifyContent:'center',alignItems:'center',width:width*0.5,height:height*0.1,borderRadius:10,alignSelf:'center',margin:height*0.02},
