...
const styles = (screenContext:ScreenContextType, width:number, height:number) =>
  StyleSheet.create({
    ...
    thumbnailButtonContainer:{height:width*0.6,width:width*0.6,borderWidth:1,alignSelf:'center',margin:height*0.1,borderRadius:10,justifyContent:'center',alignItems:'center',overflow:'hidden'},
